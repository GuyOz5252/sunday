...
/// <inheritdoc />
public partial class AddBusinessUnitBoardTicketEpic : Migration
{
    private static readonly string[] BoardsBusinessUnitSlugColumns = ["BusinessUnitId", "Slug"];
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Agencies_BusinessUnits_BusinessUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Boards_BusinessUnits_BusinessUnitId",
                        column: x => x.BusinessUnitId,
                        principalTable: "BusinessUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountManagerId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Clients_Users_AccountManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HandoffNote = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkSessions_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Agencies_BusinessUnitId",
                table: "Agencies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Boards_BusinessUnitId_Slug",
                table: "Boards",
                columns: BoardsBusinessUnitSlugColumns,
                unique: true);
